...
function ConservationStatusBar(props, status) {
  ...
  return (
    ...
    >
      ...
      <Path
        d="M125.081 0h-15.635v7.818h15.635z"
        fill="url(#h)"
        fillOpacity={1}
        stroke="none"
        strokeWidth=".189942px"
        strokeLinecap="butt"
      ...
      <Path
        ...
        strokeDashoffset={0}
        strokeOpacity={0.964706}
      />
      <Path
        d="M138.213 0a2.498 2.498 0 012.503 2.504v2.811a2.498 2.498 0 01-2.503 2.503h-13.132V0z"
        opacity={0.957}
        fill="#000015"
        fillOpacity={1}
        stroke="none"
      ...
      />
      <Path
        d="M31.27 0H15.635v7.818H31.27z"
        fill="url(#n)"
        fillOpacity={1}
        stroke="none"
        strokeWidth=".189941px"
